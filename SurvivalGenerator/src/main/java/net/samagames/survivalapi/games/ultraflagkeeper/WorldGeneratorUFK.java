...
public class WorldGeneratorUFK
{
    ...
    public static void patchBiomeParams()
    {
        try
        {
            ...
            registerBiome(6, "swampland", new BiomeForest(BiomeForest.Type.NORMAL, new BiomeData("Forest").temp(0.7F).rain(0.8F)));
            ...
            registerBiome(10, "frozen_ocean", new BiomeForest(BiomeForest.Type.NORMAL, new BiomeData("Forest").temp(0.7F).rain(0.8F)));
            registerBiome(11, "frozen_river", new BiomeForest(BiomeForest.Type.NORMAL, new BiomeData("Forest").temp(0.7F).rain(0.8F)));
            registerBiome(12, "ice_flats", new BiomeForest(BiomeForest.Type.NORMAL, new BiomeData("Forest").temp(0.7F).rain(0.8F)));
            registerBiome(13, "ice_mountains", new BiomeForest(BiomeForest.Type.NORMAL, new BiomeData("Forest").temp(0.7F).rain(0.8F)));
            registerBiome(14, "mushroom_island", new BiomeForest(BiomeForest.Type.NORMAL, new BiomeData("Forest").temp(0.7F).rain(0.8F)));
            registerBiome(15, "mushroom_island_shore", new BiomeForest(BiomeForest.Type.NORMAL, new BiomeData("Forest").temp(0.7F).rain(0.8F)));
            ...
            registerBiome(36, "savanna_rock", new BiomeForest(BiomeForest.Type.NORMAL, new BiomeData("Forest").temp(0.7F).rain(0.8F)));
            registerBiome(37, "mesa", new BiomeForest(BiomeForest.Type.NORMAL, new BiomeData("Forest").temp(0.7F).rain(0.8F)));
            registerBiome(38, "mesa_rock", new BiomeForest(BiomeForest.Type.NORMAL, new BiomeData("Forest").temp(0.7F).rain(0.8F)));
            registerBiome(39, "mesa_clear_rock", new BiomeForest(BiomeForest.Type.NORMAL, new BiomeData("Forest").temp(0.7F).rain(0.8F)));
            ...
            registerBiome(149, "mutated_jungle", new BiomeForest(BiomeForest.Type.NORMAL, new BiomeData("Forest").temp(0.7F).rain(0.8F)));
            registerBiome(151, "mutated_jungle_edge", new BiomeForest(BiomeForest.Type.NORMAL, new BiomeData("Forest").temp(0.7F).rain(0.8F)));
            ...
            registerBiome(165, "mutated_mesa", new BiomeForest(BiomeForest.Type.NORMAL, new BiomeData("Forest").temp(0.7F).rain(0.8F)));
